    ...
    <div class="header">
      ...
      <div class="form-item">
        ...
        <el-select v-model="bookType">
          <el-option v-for="item in bookTypeOptions" :key="item" :label="item" :value="item" />
        </el-select>
      </div>
      <el-button :loading="downloadLoading" type="primary" @click="handleExportExcel">Export Excel</el-button>
    </div>
...
const { filename, autoWidth, bookType, bookTypeOptions, downloadLoading, tableData } = toRefs(state)
