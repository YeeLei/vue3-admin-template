...
export const useSettingsStore = defineStore('settings', {
  state: () => {
    return {
      ...
      // 背景色
      menuBackgroundColor: getCookies('menuBackgroundColor', menuBackgroundColor),
      // 文字颜色
      menuTextColor: getCookies('menuTextColor', menuTextColor),
      // 激活项背景色
      menuActiveBackgroundColor: getCookies('menuActiveBackgroundColor', menuActiveBackgroundColor),
      // 激活项文字色
      menuActiveTextColor: getCookies('menuActiveTextColor', menuActiveTextColor),
      // 是否只保持一个子菜单的展开(手风琴)
