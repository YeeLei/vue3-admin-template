<template>
  <div class="tags-view-container" v-if="tagsView">
    <el-scrollbar ref="refScrollbar" class="tags-view-wrapper" @scroll="handleScroll" :vertical="false">
      <router-link
...
const openMenu = (tag, e) => {
  ...
  const { offsetWidth } = refScrollbar.value // container width
