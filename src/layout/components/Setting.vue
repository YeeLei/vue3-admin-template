<template>
  <div class="setting-wrapper" @click="handleDrawerOpen">
  ...
  <div class="drawer-wrapper">
    <el-drawer v-model="showSettings" title="系统配置" direction="rtl" size="310px">
      ...
      <div class="layout-wrapper">
        <el-row :gutter="20">
          <el-col :span="12" @click="handleLayoutMode('Default')">
            <div
              class="default"
              :class="{
          ...
          <el-col :span="12" @click="handleLayoutMode('Classic')">
            <div
              class="classic"
              :class="{
        ...
        <el-row :gutter="20">
          <el-col :span="12" @click="handleLayoutMode('Streamline')">
            <div
              class="streamline"
              :class="{
